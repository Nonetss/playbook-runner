      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{t("labels.navigation_title")}</SheetTitle>
            <SheetDescription>{t("labels.mobile_navigation")}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">{t("labels.toggle_sidebar")}</span>
    </Button>
  )
}

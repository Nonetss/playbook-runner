...
## Purpose
Expose Devices and Groups inventory management as independent routes under `/inventory`, with a compatible entry point at `/inventory` and sub-navigation that reflects the active inventory surface.

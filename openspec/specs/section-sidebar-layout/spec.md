...
## Purpose
Provide a reusable sidebar layout for navigation sections that have sub-items, so each section can offer a parent overview, a sidebar listing its children, and a clear active-route indicator without duplicating layout code.
